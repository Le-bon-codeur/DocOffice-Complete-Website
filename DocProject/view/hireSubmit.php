...
<style>
  ...
  <div class="container">
    ...
    <div class="content">
      <form action="../controler/hire.php" method="post">
        <div class="user-details">
          ...
          <div class="input-box">
            <span class="details">Specification</span>
            <input type="text" name="speciality" placeholder="Enter the specifications" maxlength="15" required>
          </div>
        </div>
